...
import { pillifyMentionsReplacer, pillifyKeywordsReplacer } from "../../../src/utils/pillify";
...
describe("pillify mentions", () => {
    ...
    function renderPills(input: string, mxEvent?: MatrixEvent): RenderResult {
        return render(
            <>
                {parse(input, {
                    replace: combineReplacers(pillifyMentionsReplacer)({
...
describe("pillify keywords", () => {
    ...
    function renderPills(input: string, mxEvent?: MatrixEvent): RenderResult {
        return render(
            <>
                {parse(input, {
                    replace: combineReplacers(pillifyKeywordsReplacer)({
                        mxEvent: mxEvent ?? event,
                        isHtml: true,
