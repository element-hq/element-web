...
import { fireEvent, renderHook } from "jest-matrix-react";
...
import { useUserInfoAdminPowerlevelViewModel } from "../../../../../../../src/components/viewmodels/right_panel/admin/UserInfoAdminPowerlevelViewModel";
...
describe("<PowerLevelEditor />", () => {
    ...
    const renderHook = (props = defaultProps) => {
        return renderHook(useUserInfoAdminPowerlevelViewModel(props.user, props.room), withClientContextRenderOptions(mockClient));
    };
