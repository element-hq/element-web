...
```bash
docker run --rm -p 127.0.0.1:80:8080 vectorim/element-web
```
...
```bash
docker run --rm -p 80:8080 vectorim/element-web
```
...
```bash
docker run --rm -p 127.0.0.1:80:8080 -v /etc/element-web/config.json:/app/config.json vectorim/element-web
```
