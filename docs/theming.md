...
Neuron app via CSS & custom imagery.

They are *NOT* co be confused with 'skins', which describe apps which sit on top
of matrix-react-sdk - e.g. in theory Neuron itself is a react-sdk skin.
As of Jan 2017, skins are not fully supported; Neuron is the only available skin.

To define a theme for Neuron:
