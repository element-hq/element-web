...
const meta = {
    ...
    parameters: {
        docs: {
            description: {
                component: `
A flat (non-grouped) virtualized list that renders large datasets efficiently using
[react-virtuoso](https://virtuoso.dev/), while exposing full keyboard navigation and ARIA
