...
export class Room implements IRoom {
    ...
    public getStateEvent(eventType: string, stateKey: string = ""): StateEventWatchable {
        return new StateEventWatchable(eventType, stateKey, this.sdkRoom);
    }
...
class StateEventWatchable extends Watchable<ModuleMatrixEvent | null> {
    public constructor(
