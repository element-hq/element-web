...
export default class IncompatibleController extends SettingController {
    ...
    public get incompatibleSetting(): boolean {
        if (typeof this.incompatibleValue === "function") {
            return this.incompatibleValue(this.sdkContext.settingsStore.getValue(this.settingName));
        }
        return this.sdkContext.settingsStore.getValue(this.settingName) === this.incompatibleValue;
    }
