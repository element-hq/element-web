...
import { vi, describe, it, expect, beforeAll, beforeEach, type Mocked } from "vitest";
...
import { showToast } from "./UnverifiedSessionToast";
...
describe("UnverifiedSessionToast", () => {
    ...
    beforeAll(() => {
        ...
        vi.spyOn(DeviceListener.sharedInstance(), "dismissUnverifiedSessions");
    });
