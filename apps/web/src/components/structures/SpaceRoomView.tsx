...
const SpaceLanding: React.FC<{ space: Room }> = ({ space }) => {
    ...
    const storeIsShowingSpaceMembers = useCallback(
        ...
        [sdkContext.rightPanelStore, space.roomId],
    );
...
export default class SpaceRoomView extends React.PureComponent<IProps, IState> {
    ...
    public constructor(props: IProps, context: React.ContextType<typeof SDKContext>) {
        ...
        const showSetup = this.props.justCreatedOpts && context.client?.getSafeUserId() === creator;
        ...
        this.state = {
            phase,
            showRightPanel: context.rightPanelStore.isOpenForRoom(this.props.space.roomId),
