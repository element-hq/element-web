...
import { screen, render, act, cleanup } from "test-utils-rtl";
...
describe("PipContainer", () => {
    ...
    beforeEach(async () => {
        ...
        client.getRoom.mockImplementation((roomId: string | undefined) => {
    ...
    it("shows a persistent widget with back button when viewing the room", async () => {
        ...
        await withWidget(async () => {
            ...
            const moveSpy = vi.spyOn(WidgetLayoutStore.instance, "moveToContainer");
