...
describe("LegacyCallEventGrouper", () => {
    ...
    it("should be able to answer call", () => {
        ...
        vi.spyOn(SDKContextClass.instance.legacyCallHandler, "answerCall");
        grouper.answerCall();
    ...
    it("should be able to reject call", () => {
        ...
        vi.spyOn(SDKContextClass.instance.legacyCallHandler, "hangupOrReject");
        grouper.rejectCall();
    ...
    it("should be able to callback call", () => {
        ...
        vi.spyOn(SDKContextClass.instance.legacyCallHandler, "placeCall");
        grouper.callBack();
    ...
    it("should be able to toggle call silenced", () => {
        ...
        vi.spyOn(SDKContextClass.instance.legacyCallHandler, "unSilenceCall");
        vi.spyOn(SDKContextClass.instance.legacyCallHandler, "silenceCall");

        vi.spyOn(SDKContextClass.instance.legacyCallHandler, "isCallSilenced").mockReturnValue(false);
        grouper.toggleSilenced();
        expect(SDKContextClass.instance.legacyCallHandler.silenceCall).toHaveBeenCalledWith("callId");

        vi.spyOn(SDKContextClass.instance.legacyCallHandler, "isCallSilenced").mockReturnValue(true);
        grouper.toggleSilenced();
