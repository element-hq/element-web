...
import FileDropTarget from "./FileDropTarget.tsx";
import { RoomUploadContext, type RoomUploadViewModel } from "../../viewmodels/room/RoomUploadViewModel.tsx";

vi.mock("../../../res/img/upload-big.svg", () => ({ default: "image-file-stub" }));
