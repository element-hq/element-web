...
import ManageRestrictedJoinRuleDialog from "./ManageRestrictedJoinRuleDialog";
...
describe("<ManageRestrictedJoinRuleDialog />", () => {
    ...
    it("should list spaces which are not parents of the room", () => {
        ...
        vi.spyOn(SDKContextClass.instance.spaceStore, "spacePanelSpaces", "get").mockReturnValue([space1]);
