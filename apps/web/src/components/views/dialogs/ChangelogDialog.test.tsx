...
import ChangelogDialog, { type DevelopVersionString, parseVersion } from "./ChangelogDialog";
...
describe("<ChangelogDialog />", () => {
    it("should fetch github proxy url for each repo with old and new version strings", async () => {
        ...
        const { asFragment } = render(
            <ChangelogDialog newVersion={newVersion} version={oldVersion} onFinished={vi.fn()} />,
        );
