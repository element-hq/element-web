...
import { createTestClient, flushPromisesWithFakeTimers, mkStubRoom } from "test-utils";
...
describe("<ExportDialog />", () => {
    ...
    beforeEach(() => {
        HTMLExporterMock.mockClear().mockImplementation(function () {
            return htmlExporterInstance as any;
        });
        PlainTextExporterMock.mockClear().mockImplementation(function () {
            return plainTextExporterInstance as any;
        });
