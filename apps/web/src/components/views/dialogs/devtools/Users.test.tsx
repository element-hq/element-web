...
describe("<Users />", () => {
    ...
    it("should render a single user", async () => {
        ...
        room.getJoinedMembers = vi.fn().mockReturnValue([alice]);
        ...
        vi.mocked(matrixClient.getCrypto()!.getUserDeviceInfo).mockResolvedValue(
            new Map([
                [
                    userId,
                    new Map([
        ...
        vi.mocked(matrixClient.getCrypto()!.getDeviceVerificationStatus).mockImplementation(
