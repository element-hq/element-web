...
describe("VerificationRequestDialog", () => {
    function renderComponent(phase: VerificationPhase, method?: "emoji" | "qr"): ReturnType<typeof render> {
        ...
        return render(
            <VerificationRequestDialog onFinished={vi.fn()} member={member} verificationRequest={request} />,
...
function createEmojiVerifier(): Verifier {
    ...
    return {
        getShowSasCallbacks: vi.fn().mockReturnValue(showSasCallbacks),
...
function createQrVerifier(): Verifier {
    ...
    return {
        ...
        getReciprocateQrCodeCallbacks: vi.fn().mockReturnValue(reciprocateQrCodeCallbacks),
        on: vi.fn(),
        off: vi.fn(),
        verify: vi.fn(),
    } as unknown as Verifier;
