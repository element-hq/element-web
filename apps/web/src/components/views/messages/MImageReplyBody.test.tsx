...
import MImageReplyBody, { ImageBodyBaseInner } from "./MImageReplyBody";
...
describe("<MImageReplyBody />", () => {
    ...
    const mockedUseMediaVisible = vi.mocked(useMediaVisible);
    ...
    beforeEach(() => {
        ...
        mockedUseMediaVisible.mockReturnValue([true, vi.fn()]);
        ...
        vi.spyOn(SettingsStore, "watchSetting").mockReturnValue("image-reply-watch");
    ...
    it("falls back from thumbnail errors and clears image errors after reconnecting", async () => {
        const onSpy = vi.spyOn(cli, "on");
        const offSpy = vi.spyOn(cli, "off");
