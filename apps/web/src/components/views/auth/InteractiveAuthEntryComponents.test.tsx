...
import { render, screen, waitFor, act, fireEvent } from "test-utils-rtl";
...
import {
    ...
    TermsAuthEntry,
} from "./InteractiveAuthEntryComponents";
...
describe("<MasUnlockCrossSigningAuthEntry/>", () => {
    ...
    test("should open idp in new tab on click", async () => {
        const spy = vi.spyOn(global.window, "open").mockImplementation(() => null);
        renderAuth();
