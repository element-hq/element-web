...
import { getMockClientWithEventEmitter, makeBeaconEvent, makeBeaconInfoEvent, makeRoomWithBeacons } from "test-utils";
...
describe("<BeaconListItem />", () => {
    ...
    vi.spyOn(global.Date, "now").mockReturnValue(now - 600000);
