...
import { useContainsCommand } from "./useContainsCommand";

// Mock CommandProvider
const mockGetCompletions = vi.fn();
vi.mock("../../../../../autocomplete/CommandProvider", () => {
    return {
        default: vi.fn().mockImplementation(function () {
            return { getCompletions: mockGetCompletions };
        }),
    };
});
