...
import { InviteRulesAccountSetting } from "./InviteRulesAccountSettings";
import SettingsStore from "../../../../../settings/SettingsStore";
import { type ComputedInviteConfig } from "../../../../../@types/invite-rules";
...
function mockDisabledMessage(msc4155supported: boolean, msc4380Supported: boolean) {
    vi.spyOn(SettingsStore, "disabledMessage").mockImplementation((settingName) => {
        if (settingName === "inviteRules") {
