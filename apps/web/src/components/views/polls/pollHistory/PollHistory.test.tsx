...
describe("<PollHistory />", () => {
    ...
    beforeEach(() => {
        ...
        vi.spyOn(timeline, "getEvents").mockReturnValue([]);
        vi.spyOn(defaultDispatcher, "dispatch")
            .mockClear()
            .mockImplementation(() => {});
        defaultProps.onFinished.mockClear();
        vi.spyOn(room, "getOrCreateFilteredTimelineSet");
    ...
    it("renders a loading message while poll history is fetched", async () => {
        ...
        vi.spyOn(liveTimeline, "getPaginationToken").mockReturnValueOnce("test-pagination-token");
    ...
    it("fetches poll history until end of timeline is reached while within time limit", async () => {
        ...
        vi.spyOn(liveTimeline, "getPaginationToken")
    ...
    it("fetches poll history until event older than history period is reached", async () => {
        ...
        vi.spyOn(liveTimeline, "getEvents")
            .mockReturnValueOnce([])
