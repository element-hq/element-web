...
vi.spyOn(MatrixClientPeg, "get").mockReturnValue(stubClient);

describe("VoiceRecordingStore", () => {
    const room1Id = "!room1:server.org";
    const room2Id = "!room2:server.org";
    const room3Id = "!room3:server.org";
    const room1Recording = { destroy: vi.fn() } as unknown as VoiceMessageRecording;
    const room2Recording = { destroy: vi.fn() } as unknown as VoiceMessageRecording;
