...
import { getMockedRooms } from "../__mocks__";
...
import { UnreadSorter } from "./UnreadSorter";
...
describe("UnreadSorter", () => {
    it("should sort correctly", () => {
        ...
        vi.spyOn(utils, "getMarkedUnreadState").mockImplementation((room) => markedAsUnreadRooms.includes(room));
