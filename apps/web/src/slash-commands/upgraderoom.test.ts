...
import RoomUpgradeWarningDialog, { type IFinishedOpts } from "../components/views/dialogs/RoomUpgradeWarningDialog";
import { type Command } from "./SlashCommands";
import { parseUpgradeRoomArgs } from "./upgraderoom/parseUpgradeRoomArgs";
...
describe("/upgraderoom", () => {
    ...
    function setUp(continueUpgrade: boolean): {
        ...
        const upgradeRoom = vi.fn().mockResolvedValue({ replacement_room: "!newroom" });
