...
import { createTestClient, flushPromises, TestSDKContext } from "test-utils";
...
describe("RoomListItemViewModel", () => {
    ...
    beforeEach(() => {
        ...
        vi.spyOn(SDKContextClass.instance.roomListStore, "orderedSectionTags", "get").mockReturnValue([]);
    });
