...
describe("MessageTimestampViewModel", () => {
    ...
    it("should use formatRelativeTime when showRelative is true", () => {
        vi.spyOn(DateUtils, "formatFullDate").mockReturnValue("SENT_AT");
        const formatRelativeTimeSpy = vi.spyOn(DateUtils, "formatRelativeTime").mockReturnValue("RELATIVE");
    ...
    it("should use full time when showSeconds is true without full date", () => {
        vi.spyOn(DateUtils, "formatFullDate").mockReturnValue("SENT_AT");
        const formatFullTimeSpy = vi.spyOn(DateUtils, "formatFullTime").mockReturnValue("FULL_TIME");
        const formatTimeSpy = vi.spyOn(DateUtils, "formatTime").mockReturnValue("TIME");
