...
import { EventPreviewViewModel } from "./EventPreviewViewModel";
...
describe("EventPreviewViewModel", () => {
    ...
    let decryptEventIfNeeded: Mock<MatrixClient["decryptEventIfNeeded"]>;
    ...
    beforeEach(() => {
        cli = stubClient();
        decryptEventIfNeeded = vi.spyOn(cli, "decryptEventIfNeeded").mockResolvedValue(undefined);
    });
