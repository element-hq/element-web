...
describe("EventTileReactionState", () => {
    it("gets annotation reaction relations when reactions are enabled", () => {
        ...
        const getRelationsForEvent: MockedFunction<GetRelationsForEvent> = vi.fn().mockReturnValue(relations);
    ...
    it("does not get relations when reactions are disabled", () => {
        const getRelationsForEvent: MockedFunction<GetRelationsForEvent> = vi.fn();
    ...
    it("normalizes missing relations to null", () => {
        const getRelationsForEvent: MockedFunction<GetRelationsForEvent> = vi.fn().mockReturnValue(undefined);
