...
test.describe("Timeline", () => {
    ...
    test.describe("message sending", { tag: ["@no-firefox", "@no-webkit"] }, () => {
        ...
        test("can reply with a text message", async ({ page, app, room }) => {
            ...
            await expect(eventTileLine.getByTestId("reply-tile").getByText(MESSAGE)).toBeVisible();
        ...
        test("can reply with a voice message", async ({ page, app, room, context }) => {
            ...
            await expect(lastEventTileLine.getByTestId("reply-tile").getByText(MESSAGE)).toBeVisible();
        ...
        test(
            ...
            async ({ page, app, room, homeserver }) => {
                ...
                await expect(eventTileLine.getByTestId("reply-tile").getByText(LONG_STRING)).toBeVisible();
