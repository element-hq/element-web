...
import { LISTS_LOADED_EVENT, LISTS_UPDATE_EVENT } from "../../../src/stores/room-list-v3/RoomListStoreV3";
...
describe("StoresApi", () => {
    describe("RoomListStoreApi", () => {
        it("should return promise that resolves when RLS is ready", async () => {
            ...
            const store = new StoresApi(SDKContextClass.instance);
            ...
            SDKContextClass.instance.roomListStore.emit(LISTS_LOADED_EVENT);
            // Should resolve now.
            await waitFor(() => {
        ...
        describe("getRooms()", () => {
            it("should return rooms from RLS", async () => {
                ...
                jest.spyOn(SDKContextClass.instance.roomListStore, "getSortedRooms").mockReturnValue([
                    room1,
                    room2,
                    room3,
                ]);
            ...
            it("should update from RLS", async () => {
                ...
                jest.spyOn(SDKContextClass.instance.roomListStore, "getSortedRooms").mockReturnValue(rooms);
                jest.spyOn(SDKContextClass.instance.roomListStore, "isLoadingRooms", "get").mockReturnValue(false);
                ...
                const room3 = mkRoom(cli, "!foo3:m.org");
                rooms.push(room3);
                SDKContextClass.instance.roomListStore.emit(LISTS_UPDATE_EVENT);
