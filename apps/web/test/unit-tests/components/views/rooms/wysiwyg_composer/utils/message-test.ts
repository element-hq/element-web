...
describe("message", () => {
    ...
    describe("sendMessage", () => {
        it("Should not send empty html message", async () => {
            // When
            await sendMessage("", true, { roomContext: defaultRoomContext, mxClient: mockClient, urlPreviewSnapshot: { previews: [] } });
        ...
        it("Should handle emojis", async () => {
            // When
            await sendMessage("🎉", false, { roomContext: defaultRoomContext, mxClient: mockClient, urlPreviewSnapshot: { previews: [] } });
