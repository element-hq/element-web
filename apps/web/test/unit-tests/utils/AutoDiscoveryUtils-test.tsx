...
describe("AutoDiscoveryUtils", () => {
    ...
    describe("buildValidatedConfigFromDiscovery()", () => {
        ...
        it("should validate delegated oidc auth", async () => {
            ...
            fetchMock.get(`${validHsConfig["m.homeserver"].base_url}/_matrix/client/versions`, {});
            fetchMock.get(
                `${validHsConfig["m.homeserver"].base_url}/_matrix/client/unstable/org.matrix.msc2965/auth_metadata`,
                {
