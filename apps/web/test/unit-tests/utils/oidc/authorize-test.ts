...
import * as randomStringUtils from "matrix-js-sdk/lib/randomstring";
...
jest.unmock("matrix-js-sdk/lib/randomstring");

jest.mock("matrix-js-sdk/lib/oidc/authorize", () => ({
    ...jest.requireActual("matrix-js-sdk/lib/oidc/authorize"),
