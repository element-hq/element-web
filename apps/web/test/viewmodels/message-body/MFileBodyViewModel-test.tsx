...
import { MFileBodyViewInfoIcon } from "@element-hq/web-shared-components";

import Modal from "../../../src/Modal";
import { TimelineRenderingType } from "../../../src/contexts/RoomContext";
import { type MediaEventHelper } from "../../../src/utils/MediaEventHelper";
import { MFileBodyViewModel } from "../../../src/viewmodels/message-body/MFileBodyViewModel";
...
describe("MFileBodyViewModel", () => {
    ...
    const createVm = (
        overrides: Partial<ConstructorParameters<typeof MFileBodyViewModel>[0]> = {},
    ): MFileBodyViewModel =>
    ...
    it.each([
        { msgtype: "m.file", expectedIcon: MFileBodyViewInfoIcon.ATTACHMENT },
        { msgtype: "m.audio", expectedIcon: MFileBodyViewInfoIcon.AUDIO },
        { msgtype: "m.video", expectedIcon: MFileBodyViewInfoIcon.VIDEO },
