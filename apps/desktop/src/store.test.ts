...
import { expect, describe, it, beforeAll, beforeEach, vi, MockInstance, afterEach } from "vitest";
import { app, dialog, safeStorage } from "electron";

import Store, { Mode, SafeStorageDecryptionError, clearData } from "./store.js";
