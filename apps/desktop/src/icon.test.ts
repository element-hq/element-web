...
describe("getIconPath", () => {
    ...
    it("should use .ico on Windows", async () => {
        ...
        await expect(getIconPath()).resolves.toEqual(path.resolve(__dirname, "../build/icon.ico"));
    });
    it("should use .png on macOS", async () => {
        vi.spyOn(process, "platform", "get").mockReturnValue("darwin");
        await expect(getIconPath()).resolves.toEqual(path.resolve(__dirname, "../build/icon.png"));
    });
