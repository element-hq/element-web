...
import TabbedView, { Tab, useActiveTabWithDefault } from "../../../../components/structures/TabbedView";
import { _t, _td } from "../../../../languageHandler";
import AccountUserSettingsTab from "../../../../components/views/settings/tabs/user/AccountUserSettingsTab";
import SettingsStore from "../../../../settings/SettingsStore";
import LabsUserSettingsTab, { showLabsFlags } from "../../../../components/views/settings/tabs/user/LabsUserSettingsTab";
import AppearanceUserSettingsTab from "../../../../components/views/settings/tabs/user/AppearanceUserSettingsTab";
import SecurityUserSettingsTab from "../../../../components/views/settings/tabs/user/SecurityUserSettingsTab";
import NotificationUserSettingsTab from "../../../../components/views/settings/tabs/user/NotificationUserSettingsTab";
import PreferencesUserSettingsTab from "../../../../components/views/settings/tabs/user/PreferencesUserSettingsTab";
import VoiceUserSettingsTab from "../../../../components/views/settings/tabs/user/VoiceUserSettingsTab";
import HelpUserSettingsTab from "../../../../components/views/settings/tabs/user/HelpUserSettingsTab";
import MjolnirUserSettingsTab from "../../../../components/views/settings/tabs/user/MjolnirUserSettingsTab";
import { UIFeature } from "../../../../settings/UIFeature";
import BaseDialog from "../../../../components/views/dialogs/BaseDialog";
import SidebarUserSettingsTab from "../../../../components/views/settings/tabs/user/SidebarUserSettingsTab";
import KeyboardUserSettingsTab from "../../../../components/views/settings/tabs/user/KeyboardUserSettingsTab";
import SessionManagerTab from "../../../../components/views/settings/tabs/user/SessionManagerTab";
...
import { EncryptionUserSettingsTab, type State } from "../../../../components/views/settings/tabs/user/EncryptionUserSettingsTab";
