...
import { ChevronFace, ContextMenuTooltipButton, type MenuProps } from "../../../../components/structures/ContextMenu";
...
import { RoomGeneralContextMenu } from "../../../../components/views/context_menus/RoomGeneralContextMenu";
import { CallStore, CallStoreEvent } from "../../../../stores/CallStore";
import { SdkContextClass } from "../../../../contexts/SDKContext";
import { RoomTileSubtitle } from "../../../../components/views/rooms/RoomTileSubtitle";
...
class RoomTile extends React.PureComponent<Props, State> {
    ...
    public render(): React.ReactElement {
        const classes = classNames({
            ...
            // quali.chat custom
            mx_RoomTile_unread: this.notificationState.isUnread,
        });
        ...
        const titleContainer = this.props.isMinimized ? null : (
            <div className="mx_RoomTile_titleContainer">
                <div title={name} className={titleClasses} tabIndex={-1}>
                   {/* quali.chat custom */}
                   <RoomTitle name={name} shouldShortenAddress={true} />
                </div>
                {subtitle}
            </div>
        );
