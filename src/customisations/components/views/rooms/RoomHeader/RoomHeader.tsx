...
import { Flex } from "../../../../../components/utils/Flex.tsx";
import { Box } from "../../../../../components/utils/Box.tsx";
...
import FacePile from "../../../../../components/views/elements/FacePile.tsx";
import { useRoomState } from "../../../../../hooks/useRoomState.ts";
import RoomAvatar from "../../../../../components/views/avatars/RoomAvatar.tsx";
import { formatCount } from "../../../../../utils/FormattingUtils.ts";
import RightPanelStore from "../../../../../stores/right-panel/RightPanelStore.ts";
import PosthogTrackers from "../../../../../PosthogTrackers.ts";
import { VideoRoomChatButton } from "../../../../../components/views/rooms/RoomHeader/VideoRoomChatButton.tsx";
import { RoomKnocksBar } from "../../../../../components/views/rooms/RoomKnocksBar.tsx";
...
import { CallGuestLinkButton } from "../../../../../components/views/rooms/RoomHeader/CallGuestLinkButton.tsx";
import { type ButtonEvent } from "../../../../../components/views/elements/AccessibleButton.tsx";
import WithPresenceIndicator, { useDmMember } from "../../../../../components/views/avatars/WithPresenceIndicator.tsx";
import { type IOOBData } from "../../../../../stores/ThreepidInviteStore.ts";
import { MainSplitContentType } from "../../../../../components/structures/RoomView.tsx";
import defaultDispatcher from "../../../../../dispatcher/dispatcher.ts";
import { RoomSettingsTab } from "../../../../../components/views/dialogs/RoomSettingsDialog.tsx";
import { useScopedRoomContext } from "../../../../../contexts/ScopedRoomContext.tsx";
import { ToggleableIcon } from "../../../../../components/views/rooms/RoomHeader/toggle/ToggleableIcon.tsx";
import { CurrentRightPanelPhaseContextProvider } from "../../../../../contexts/CurrentRightPanelPhaseContext.tsx";
import CopyableText from "../../../../../components/views/elements/CopyableText.tsx";
...
export default function RoomHeader({
    ...
    // quali.chat custom
    const roomContractAddress = (() => {
        // #PUB_TOKEN_CONTRACTADDRESS_CHAINNAME:domain
        const canonicalAlias = room.getCanonicalAlias();
        if (!canonicalAlias) return undefined;

        // Match the chain using the final _CHAIN: pattern
        const chainMatch = canonicalAlias.match(/_([A-Z]+):/g);
        if (!chainMatch) return undefined;

        const chain = chainMatch[0];
        const endIndex = canonicalAlias.lastIndexOf(`${chain}`);
        if (endIndex === -1) return undefined;

        const beforeChain = canonicalAlias.slice(0, endIndex);
        // Split in reverse
        const parts = beforeChain.split('_');
                    ...
                    >
                        <Box flex="1" className="mx_RoomHeader_info">
                            ...
                            >
                                ...
                                {!isDirectMessage && roomContractAddress && (
                                    <CopyableText
                                        border={false}
                                        getTextToCopy={() => roomContractAddress}
                                        onClick={(e) => {
                                            e.stopPropagation();
                                        }}
                                    />
