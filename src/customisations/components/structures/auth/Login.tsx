...
import PasswordLogin from "../../../../components/views/auth/PasswordLogin";
import InlineSpinner from "../../../../components/views/elements/InlineSpinner";
import Spinner from "../../../../components/views/elements/Spinner";
import SSOButtons from "../../../../components/views/elements/SSOButtons";
import ServerPicker from "../../../../components/views/elements/ServerPicker";
import AuthBody from "../../views/auth/AuthBody";
import AuthHeader from "../../../../components/views/auth/AuthHeader";
...
export default class LoginComponent extends React.PureComponent<IProps, IState> {
    ...
    public renderLoginComponentForFlows(): ReactNode {
        ...
        const order = ["oidcNativeFlow", "m.login.sso"];
    ...
    public render(): React.ReactNode {
        ...
        return (
            <AuthPage>
                ...
                <AuthBody>{this.renderLoginComponentForFlows()}</AuthBody>
            </AuthPage>
        );
    }
}
