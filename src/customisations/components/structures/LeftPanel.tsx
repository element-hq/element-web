...
import LegacyRoomList from "../../../components/views/rooms/LegacyRoomList";
...
import LegacyRoomListHeader from "../../../components/views/rooms/LegacyRoomListHeader";
...
import { RoomListPanel } from "../../../components/views/rooms/RoomListPanel";
...
export default class LeftPanel extends React.Component<IProps, IState> {
    ...
    private renderHeader(): React.ReactNode {
        return (
            <div
                className={classNames("mx_LeftPanel_headerContainer", {
                    mx_LeftPanel_headerContainer_minimized: this.props.isMinimized,
                })}
            >
                <img
                    src={
                        this.props.isMinimized
                            ? require("../../../../res/img/logo-compact.svg").default
                            : require("../../../../res/img/logo.svg").default
                    }
                    className="mx_LeftPanel_logo"
                    alt="Logo"
                />
            </div>
        );
