...
export default abstract class Exporter {
    ...
    protected constructor(
        ...
        if (
            ...
            exportOptions.maxSize > 32768 * 1024 * 1024 || // More than 32 GB
    ...
    protected async downloadZIP(): Promise<string | void> {
        ...
        const zipWriter = new ZipWriter(zipFileWriter, { zip64: true });
        ...
        for (const file of this.files.reverse()) {
            ...
            try {
                await zipWriter.add(filename, file.blob.stream(), {zip64: true});
            } catch (e) {
