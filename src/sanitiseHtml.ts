...
import { type IOptions, type Attributes } from "sanitize-html";

import { tryTransformPermalinkToLocalHref } from "./utils/permalinks/Permalinks.ts";
import { ELEMENT_URL_PATTERN } from "./linkify-matrix.ts";
import SettingsStore from "./settings/SettingsStore.ts";
import { mediaFromMxc } from "./customisations/Media.ts";
import { PERMITTED_URL_SCHEMES } from "./utils/UrlUtils.ts";
...
export const transformTags: NonNullable<IOptions["transformTags"]> = {
    ...
    "a": function (tagName: string, attribs: Attributes) {
        if (attribs.href) {
    ...
    "img": function (tagName: string, attribs: Attributes) {
        let src = attribs.src;
    ...
    "code": function (tagName: string, attribs: Attributes) {
    ...
    "*": function (tagName: string, attribs: Attributes) {
