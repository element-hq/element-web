...
import { AudioPlayer, type AudioPlayerActions, type AudioPlayerSnapshot } from "./AudioPlayer";
...
describe("AudioPlayer", () => {
    ...
    class AudioPlayerViewModel extends MockViewModel<AudioPlayerSnapshot> implements AudioPlayerActions {
