 ...
 */
export type AudioPlayerViewModel = ViewModel<AudioPlayerSnapshot> & AudioPlayerActions;
 ...
 * @example
 * ```tsx
 * <AudioPlayer vm={audioPlayerViewModel} />
 * ```
 */
export function AudioPlayer({ vm }: AudioPlayerProps): JSX.Element {
    const {
        playbackPhase,
    ...
    const disabled = playbackPhase === "decoding";
        ...
        <>
            ...
            >
                <Flex gap="var(--cpd-space-2x)" align="center">
                    ...
                    />
                    <Box flex="1" className={styles.mediaInfo}>
                        <span className={styles.mediaName}>{mediaName}</span>
                ...
                <Flex align="center" gap="var(--cpd-space-1x)">
                    ...
                    <Clock seconds={playedSeconds} role="timer" />
                </Flex>
            </MediaBody>
