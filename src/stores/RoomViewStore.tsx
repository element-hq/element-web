...
import { MatrixError, JoinRule, type Room, type MatrixEvent, IJoinRoomOpts } from "matrix-js-sdk/src/matrix";
...
export class RoomViewStore extends EventEmitter {
    ...
    private async joinRoom(payload: JoinRoomPayload): Promise<void> {
        ...
        const joinOpts: IJoinRoomOpts = {
            ...
            acceptSharedHistory: SettingsStore.getValue("feature_share_history_on_invite"),
            ...(payload.opts ?? {}),
        };
        try {
