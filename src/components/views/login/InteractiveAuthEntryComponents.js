...
export const EmailIdentityAuthEntry = React.createClass({
    ...
    render: function() {
        if (this.state.requestingToken) {
            ...
            return (
                <div>
                    <p>{ _t("An email has been sent to %(emailAddress)s", { emailAddress: '<i>' + this.props.inputs.emailAddress + '</i>' }) }</p>
...
export const MsisdnAuthEntry = React.createClass({
    ...
    render: function() {
        if (this.state.requestingToken) {
            ...
            return (
                <div>
                    <p>{ _t("A text message has been sent to %(msisdn)s", { msisdn: '<i>' + this._msisdn + '</i>' }) }</p>
