...
RIOT_SHA=$(git rev-parse --short=12 HEAD) # use the ACTUAL SHA rather than assume develop

DIST_VERSION=$RIOT_SHA-react-$REACT_SHA-js-$JSSDK_SHA scripts/package.sh -d
